...
namespace Project.Scripts.Configs
{
    ...
    public class DamageConfig : ScriptableObject
    {
        ...
        [Tooltip("Maximum charge the player avatar bar can hold. When full the player taps to discharge and deal damage to the enemy.")]
        [SerializeField] private int _maxAvatarCharge = 80;
